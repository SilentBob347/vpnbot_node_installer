...
VPNBOT_NODE_WATCHDOG_PROD_HOST="${VPNBOT_NODE_WATCHDOG_PROD_HOST:-31.77.143.77}"
...
VPNBOT_SSH_GUARD_TRUSTED_IPS="${VPNBOT_SSH_GUARD_TRUSTED_IPS:-31.77.143.77}"
...
TRUSTED_IPS="${VPNBOT_SSH_GUARD_TRUSTED_IPS:-31.77.143.77}"
