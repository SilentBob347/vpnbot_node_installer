...
VPNBOT_NODE_WATCHDOG_PROD_HOST="${VPNBOT_NODE_WATCHDOG_PROD_HOST:-144.31.107.88}"
...
VPNBOT_SSH_GUARD_TRUSTED_IPS="${VPNBOT_SSH_GUARD_TRUSTED_IPS:-144.31.107.88}"
...
write_xray_logrotate_config() {
    ...
    XRAY_LOGROTATE_MAXAGE_DAYS="${XRAY_LOGROTATE_MAXAGE_DAYS}" \
...
Environment=VPNBOT_NODE_WATCHDOG_PROD_PORT=22
...
TRUSTED_IPS="${VPNBOT_SSH_GUARD_TRUSTED_IPS:-144.31.107.88}"
